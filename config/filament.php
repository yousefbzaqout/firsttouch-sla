...
return [
    ...
    */
    ...
    'broadcasting' => [
        ...
        /*
         * Only wire Laravel Echo when a Reverb/Pusher key is configured.
         * Without a key, Filament would throw: "You must pass your app key when you instantiate Pusher."
         */
        'echo' => filled(env('VITE_REVERB_APP_KEY', env('REVERB_APP_KEY')))
            ? [
                'broadcaster' => env('FILAMENT_ECHO_BROADCASTER', 'reverb'),
                ...
                'wssPort' => (int) env('VITE_REVERB_PORT', env('REVERB_PORT', 443)),
